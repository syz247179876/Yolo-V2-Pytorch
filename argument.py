...
class Args(object):
    ...
    def set_train_args(self):
        ...
        self.parser.add_argument('-lr', type=float, default=.0001, help='learning rate')
        self.parser.add_argument('--weight_decay', type=float, default=1e-4, help='regularization coefficient')
        self.parser.add_argument('--pretrain_file', type=str, default=None, help='store the latest model file')
